...
const changePassword = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield auth_service_1.AuthService.changePassword(user_id, passwordData);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
...
const forgotPassword = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _b;
    const result = yield auth_service_1.AuthService.forgotPassword((_b = req === null || req === void 0 ? void 0 : req.body) === null || _b === void 0 ? void 0 : _b.email);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
        message: result,
