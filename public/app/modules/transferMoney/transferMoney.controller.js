...
exports.TransferMoneyController = void 0;
const http_status_1 = __importDefault(require("http-status"));
const catchAsync_1 = __importDefault(require("../../../shared/catchAsync"));
const sendResponse_1 = __importDefault(require("../../../shared/sendResponse"));
const transferMoney_service_1 = require("./transferMoney.service");
const transferMoney = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield transferMoney_service_1.TransferMoneyService.transferMoney({
        amount,
        sender_id,
        receiver_id,
    });
...
exports.TransferMoneyController = {
    transferMoney,
};
